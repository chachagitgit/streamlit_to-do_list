...
# Mark a task as complete
    ...
    if tasks:
        task_to_complete = st.selectbox("Select Task", [f"{idx + 1}. {task['name']} [Priority: {task['priority']}] [Deadline: {task['deadline'] or 'No deadline'}]" for idx, task in enumerate(tasks)])
